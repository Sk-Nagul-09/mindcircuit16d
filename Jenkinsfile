    ...
    stages {
        ...
        stage('Deploy to Tomcat') {
            steps {
                ...
                deploy adapters: [tomcat9(alternativeDeploymentContext: '', credentialsId: 'tomcat', path: '', url: 'http://ec2-54-242-109-121.compute-1.amazonaws.com:8080/')], contextPath: 'MC-APP', war: '**/*.war'
            }
        }		
