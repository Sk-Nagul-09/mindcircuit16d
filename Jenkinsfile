    ...
    stages {
        ...
        stage('Deploy to Tomcat') {
            steps {
                ...
                deploy adapters: [tomcat9(alternativeDeploymentContext: '', credentialsId: 'tomcat', path: '', url: 'http://ec2-98-81-77-148.compute-1.amazonaws.com:8080/')], contextPath: 'MC-APP', war: '**/*.war'
            }
        }		
